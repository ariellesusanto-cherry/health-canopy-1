// ============================================================
// Mock Data for Health Canopy — Contra Costa Health
// ============================================================
...
export const organization = {
  ...
  locations: [
    { id: "ccrmc", name: "Contra Costa Regional Medical Center", city: "Martinez, CA" },
    { id: "martinez-health", name: "Martinez Health Center", city: "Martinez, CA" },
    { id: "martinez-wellness", name: "Martinez Wellness Center", city: "Martinez, CA" },
  ],
};

export const departments = [
  { id: "ed", name: "Emergency Department", icon: "Siren", itemCount: 3245, location: "ccrmc" },
  { id: "or", name: "Operating Rooms", icon: "Scissors", itemCount: 4872, location: "ccrmc" },
  { id: "pharmacy", name: "Pharmacy", icon: "Pill", itemCount: 6430, location: "ccrmc" },
  { id: "central-supply", name: "Materials Management", icon: "Warehouse", itemCount: 11246, location: "ccrmc" },
  { id: "icu", name: "Intensive Care Unit", icon: "HeartPulse", itemCount: 2912, location: "ccrmc" },
  { id: "medsurg", name: "Med/Surg", icon: "Bed", itemCount: 2468, location: "ccrmc" },
  { id: "ld", name: "Labor & Delivery", icon: "Baby", itemCount: 1974, location: "martinez-health" },
  { id: "lab", name: "Laboratory", icon: "FlaskConical", itemCount: 4218, location: "ccrmc" },
  { id: "transplant", name: "Transplant Services", icon: "HeartPulse", itemCount: 1856, location: "ccrmc" },
  { id: "oncology", name: "Oncology / Cancer Center", icon: "Activity", itemCount: 2134, location: "martinez-health" },
  { id: "neuro", name: "Neurosciences", icon: "Brain", itemCount: 1645, location: "ccrmc" },
  { id: "cardiology", name: "Cardiology", icon: "HeartPulse", itemCount: 1523, location: "ccrmc" },
];
...
export const itemLocations: Record<string, StockLocation[]> = {
  "INV-001": [ // Nitrile Gloves
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 12000, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 2400, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 1600, storageType: "shelf" },
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 2800, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4B", floor: "CCRMC 4th Floor", qty: 1200, storageType: "shelf" },
    { location: "CCRMC Family Birth Center Supply", floor: "CCRMC 2nd Floor", qty: 800, storageType: "shelf" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 2000, storageType: "shelf" },
    { location: "Martinez Wellness Center Supply", floor: "Martinez Health Center", qty: 2000, storageType: "shelf" },
  ],
  "INV-002": [ // N95 Masks
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 3000, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 1000, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 600, storageType: "shelf" },
    { location: "Respiratory Therapy — CCRMC", floor: "CCRMC 3rd Floor", qty: 400, storageType: "cabinet" },
    { location: "Isolation Cart — 4A", floor: "CCRMC 4th Floor", qty: 400, storageType: "cart" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 600, storageType: "shelf" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 400, storageType: "shelf" },
  ],
  "INV-003": [ // IV Catheter 20G
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 400, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 200, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4B", floor: "CCRMC 4th Floor", qty: 160, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 140, storageType: "shelf" },
  ],
  "INV-004": [ // Propofol
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 240, storageType: "refrigerator" },
    { location: "OR Anesthesia Workroom", floor: "CCRMC 2nd Floor", qty: 80, storageType: "refrigerator" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 30, storageType: "pyxis" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 10, storageType: "pyxis" },
  ],
  "INV-005": [ // Surgical Drape Kit — Total Knee
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 110, storageType: "shelf" },
    { location: "SPD — Sterile Processing", floor: "Basement", qty: 40, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 20, storageType: "shelf" },
  ],
  "INV-006": [ // Heparin
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 50, storageType: "shelf" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 16, storageType: "pyxis" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 14, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4B", floor: "CCRMC 4th Floor", qty: 10, storageType: "pyxis" },
  ],
  "INV-007": [ // Endotracheal Tube 7.5mm
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 100, storageType: "cabinet" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 60, storageType: "cabinet" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 50, storageType: "shelf" },
    { location: "OR Anesthesia Workroom", floor: "CCRMC 2nd Floor", qty: 30, storageType: "cabinet" },
  ],
  "INV-008": [ // Foley Catheter 16Fr
    { location: "CCRMC Med/Surg 4B", floor: "CCRMC 4th Floor", qty: 160, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4A", floor: "CCRMC 4th Floor", qty: 100, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 80, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 50, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 30, storageType: "shelf" },
  ],
  "INV-009": [ // Fentanyl (Controlled Substance)
    { location: "Pharmacy — Controlled Substance Vault", floor: "CCRMC 1st Floor", qty: 400, storageType: "cage" },
    { location: "OR Anesthesia Pyxis", floor: "CCRMC 2nd Floor", qty: 120, storageType: "pyxis" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 80, storageType: "pyxis" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 50, storageType: "pyxis" },
    { location: "CCRMC Family Birth Center Pyxis", floor: "CCRMC 2nd Floor", qty: 30, storageType: "pyxis" },
  ],
  "INV-010": [ // Sterile Surgical Gown (L)
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 500, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 300, storageType: "shelf" },
    { location: "SPD — Sterile Processing", floor: "Basement", qty: 160, storageType: "shelf" },
    { location: "CCRMC Family Birth Center Supply", floor: "CCRMC 2nd Floor", qty: 80, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 40, storageType: "shelf" },
  ],
  "INV-011": [ // Blood Collection Tubes (EDTA)
    { location: "Lab Supply Room — CCRMC", floor: "CCRMC 1st Floor", qty: 8000, storageType: "shelf" },
    { location: "Lab — Blood Bank", floor: "CCRMC 1st Floor", qty: 4000, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 3000, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 1200, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 800, storageType: "shelf" },
  ],
  "INV-012": [ // Oxytocin
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 80, storageType: "refrigerator" },
    { location: "CCRMC Family Birth Center Pyxis", floor: "CCRMC 2nd Floor", qty: 60, storageType: "pyxis" },
    { location: "CCRMC Family Birth Center Medication Room", floor: "CCRMC 2nd Floor", qty: 50, storageType: "refrigerator" },
  ],
  "INV-013": [ // Vicryl Sutures
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 20, storageType: "cabinet" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 10, storageType: "shelf" },
  ],
  "INV-014": [ // COVID Tests
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 1600, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 1500, storageType: "shelf" },
    { location: "Lab — Testing Area", floor: "CCRMC 1st Floor", qty: 600, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 500, storageType: "shelf" },
  ],
  "INV-015": [ // Ventilator Circuits (OUT OF STOCK)
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 0, storageType: "shelf" },
    { location: "Respiratory Therapy — CCRMC", floor: "CCRMC 3rd Floor", qty: 0, storageType: "shelf" },
  ],
  "INV-018": [ // Surgical Mask — Level 3
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 8000, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 2500, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 1800, storageType: "shelf" },
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 2200, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 2000, storageType: "shelf" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 2000, storageType: "shelf" },
  ],
  "INV-019": [ // Face Shield — Anti-Fog
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 1200, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 800, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 500, storageType: "shelf" },
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 700, storageType: "shelf" },
  ],
  "INV-020": [ // Sterile Surgical Gown (XL)
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 300, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 180, storageType: "shelf" },
    { location: "SPD — Sterile Processing", floor: "Basement", qty: 100, storageType: "shelf" },
    { location: "CCRMC Family Birth Center Supply", floor: "CCRMC 2nd Floor", qty: 40, storageType: "shelf" },
  ],
  "INV-021": [ // Isolation Gown — Yellow
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 3500, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 1200, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 800, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4B", floor: "CCRMC 4th Floor", qty: 900, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 1000, storageType: "shelf" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 1000, storageType: "shelf" },
  ],
  "INV-024": [ // IV Catheter 18G
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 450, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 250, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4B", floor: "CCRMC 4th Floor", qty: 180, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 220, storageType: "shelf" },
  ],
  "INV-026": [ // Central Venous Catheter Kit (Triple Lumen)
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 30, storageType: "cabinet" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 20, storageType: "cabinet" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 25, storageType: "shelf" },
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 10, storageType: "cabinet" },
  ],
  "INV-028": [ // IV Extension Set (Standard)
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 1800, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 600, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 500, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4B", floor: "CCRMC 4th Floor", qty: 400, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 500, storageType: "shelf" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 400, storageType: "shelf" },
  ],
  "INV-029": [ // Normal Saline 0.9% 1000mL (CRITICAL)
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 600, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 300, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 250, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4B", floor: "CCRMC 4th Floor", qty: 200, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 250, storageType: "shelf" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 200, storageType: "shelf" },
  ],
  "INV-030": [ // Lactated Ringer's 1000mL (LOW STOCK)
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 400, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 250, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 200, storageType: "shelf" },
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 200, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 150, storageType: "shelf" },
  ],
  "INV-032": [ // Morphine Sulfate 4mg/mL (Controlled Substance)
    { location: "Pharmacy — Controlled Substance Vault", floor: "CCRMC 1st Floor", qty: 280, storageType: "cage" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 60, storageType: "pyxis" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 50, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4B", floor: "CCRMC 4th Floor", qty: 40, storageType: "pyxis" },
    { location: "OR Anesthesia Pyxis", floor: "CCRMC 2nd Floor", qty: 50, storageType: "pyxis" },
    { location: "CCRMC Family Birth Center Pyxis", floor: "CCRMC 2nd Floor", qty: 40, storageType: "pyxis" },
  ],
  "INV-033": [ // Midazolam 5mg/mL (Controlled Substance)
    { location: "Pharmacy — Controlled Substance Vault", floor: "CCRMC 1st Floor", qty: 200, storageType: "cage" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 50, storageType: "pyxis" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 40, storageType: "pyxis" },
    { location: "OR Anesthesia Pyxis", floor: "CCRMC 2nd Floor", qty: 60, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4B", floor: "CCRMC 4th Floor", qty: 30, storageType: "pyxis" },
  ],
  "INV-034": [ // Vancomycin 1g IV
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 250, storageType: "shelf" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 60, storageType: "pyxis" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 50, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4B", floor: "CCRMC 4th Floor", qty: 40, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4A", floor: "CCRMC 4th Floor", qty: 50, storageType: "pyxis" },
  ],
  "INV-035": [ // Ceftriaxone 1g IV
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 200, storageType: "shelf" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 60, storageType: "pyxis" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 50, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4B", floor: "CCRMC 4th Floor", qty: 40, storageType: "pyxis" },
    { location: "CCRMC Family Birth Center Pyxis", floor: "CCRMC 2nd Floor", qty: 30, storageType: "pyxis" },
  ],
  "INV-037": [ // Epinephrine 1mg/mL (1:1000)
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 100, storageType: "refrigerator" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 40, storageType: "pyxis" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 35, storageType: "pyxis" },
    { location: "OR Anesthesia Pyxis", floor: "CCRMC 2nd Floor", qty: 35, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4B", floor: "CCRMC 4th Floor", qty: 30, storageType: "pyxis" },
  ],
  "INV-038": [ // Norepinephrine 4mg/4mL
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 80, storageType: "refrigerator" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 50, storageType: "pyxis" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 30, storageType: "pyxis" },
    { location: "OR Anesthesia Pyxis", floor: "CCRMC 2nd Floor", qty: 20, storageType: "pyxis" },
  ],
  "INV-039": [ // Insulin Glargine (LOW STOCK)
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 60, storageType: "refrigerator" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 15, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4B", floor: "CCRMC 4th Floor", qty: 20, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4A", floor: "CCRMC 4th Floor", qty: 15, storageType: "pyxis" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 10, storageType: "pyxis" },
  ],
  "INV-040": [ // Ondansetron 4mg/2mL (Zofran)
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 400, storageType: "shelf" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 100, storageType: "pyxis" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 80, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4B", floor: "CCRMC 4th Floor", qty: 80, storageType: "pyxis" },
    { location: "OR Anesthesia Pyxis", floor: "CCRMC 2nd Floor", qty: 90, storageType: "pyxis" },
    { location: "CCRMC Family Birth Center Pyxis", floor: "CCRMC 2nd Floor", qty: 100, storageType: "pyxis" },
  ],
  "INV-041": [ // Ketorolac 30mg/mL (Toradol)
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 180, storageType: "shelf" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 80, storageType: "pyxis" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 50, storageType: "pyxis" },
    { location: "OR Anesthesia Pyxis", floor: "CCRMC 2nd Floor", qty: 60, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4B", floor: "CCRMC 4th Floor", qty: 40, storageType: "pyxis" },
  ],
  "INV-042": [ // Lorazepam 2mg/mL (Ativan) (Controlled Substance)
    { location: "Pharmacy — Controlled Substance Vault", floor: "CCRMC 1st Floor", qty: 130, storageType: "cage" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 40, storageType: "pyxis" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 35, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4B", floor: "CCRMC 4th Floor", qty: 30, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4A", floor: "CCRMC 4th Floor", qty: 25, storageType: "pyxis" },
  ],
  "INV-045": [ // Cisplatin 50mg/50mL (LOW STOCK)
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 40, storageType: "refrigerator" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 25, storageType: "refrigerator" },
  ],
  "INV-046": [ // Pembrolizumab 100mg/4mL (Keytruda) (LOW STOCK)
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 14, storageType: "refrigerator" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 10, storageType: "refrigerator" },
  ],
  "INV-047": [ // Alteplase 100mg (tPA)
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 8, storageType: "refrigerator" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 4, storageType: "pyxis" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 3, storageType: "pyxis" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 3, storageType: "refrigerator" },
  ],
  "INV-048": [ // Levetiracetam 500mg/5mL IV (Keppra)
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 160, storageType: "shelf" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 50, storageType: "pyxis" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 50, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4B", floor: "CCRMC 4th Floor", qty: 30, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4A", floor: "CCRMC 4th Floor", qty: 30, storageType: "pyxis" },
  ],
  "INV-049": [ // Amiodarone 150mg/3mL IV
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 90, storageType: "shelf" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 35, storageType: "pyxis" },
    { location: "ED Pyxis Station", floor: "CCRMC 1st Floor", qty: 35, storageType: "pyxis" },
    { location: "Med/Surg Pyxis — 4B", floor: "CCRMC 4th Floor", qty: 30, storageType: "pyxis" },
  ],
  "INV-051": [ // Suture — Monocryl 3-0
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 160, storageType: "cabinet" },
    { location: "SPD — Sterile Processing", floor: "Basement", qty: 60, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 40, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 20, storageType: "cabinet" },
  ],
  "INV-054": [ // Surgical Drape Kit — Hip
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 65, storageType: "shelf" },
    { location: "SPD — Sterile Processing", floor: "Basement", qty: 30, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 15, storageType: "shelf" },
  ],
  "INV-055": [ // Laparoscopic Trocar Kit
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 55, storageType: "cabinet" },
    { location: "SPD — Sterile Processing", floor: "Basement", qty: 25, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 15, storageType: "shelf" },
  ],
  "INV-056": [ // Bone Cement 40g (LOW STOCK)
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 30, storageType: "cabinet" },
    { location: "SPD — Sterile Processing", floor: "Basement", qty: 10, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 8, storageType: "shelf" },
  ],
  "INV-058": [ // Cautery Pencil — Disposable
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 180, storageType: "shelf" },
    { location: "SPD — Sterile Processing", floor: "Basement", qty: 60, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 50, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 30, storageType: "shelf" },
  ],
  "INV-060": [ // Bone Graft Substitute 10cc (LOW STOCK)
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 15, storageType: "cabinet" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 7, storageType: "shelf" },
  ],
  "INV-061": [ // Endotracheal Tube 7.0mm
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 80, storageType: "cabinet" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 50, storageType: "cabinet" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 40, storageType: "shelf" },
    { location: "OR Anesthesia Workroom", floor: "CCRMC 2nd Floor", qty: 30, storageType: "cabinet" },
  ],
  "INV-063": [ // Oxygen Nasal Cannula (Adult)
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 1200, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 500, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 400, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4B", floor: "CCRMC 4th Floor", qty: 400, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4A", floor: "CCRMC 4th Floor", qty: 400, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 300, storageType: "shelf" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 300, storageType: "shelf" },
  ],
  "INV-064": [ // High-Flow Nasal Cannula Kit (LOW STOCK)
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 25, storageType: "cabinet" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 15, storageType: "cabinet" },
    { location: "Respiratory Therapy — CCRMC", floor: "CCRMC 3rd Floor", qty: 15, storageType: "cabinet" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 10, storageType: "shelf" },
  ],
  "INV-065": [ // Suction Catheter 14Fr
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 180, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 100, storageType: "shelf" },
    { location: "Respiratory Therapy — CCRMC", floor: "CCRMC 3rd Floor", qty: 80, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 120, storageType: "shelf" },
  ],
  "INV-067": [ // Blood Collection Tubes (Heparin — Green)
    { location: "Lab Supply Room — CCRMC", floor: "CCRMC 1st Floor", qty: 5000, storageType: "shelf" },
    { location: "Lab — Blood Bank", floor: "CCRMC 1st Floor", qty: 2500, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 2000, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 1200, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 800, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 500, storageType: "shelf" },
  ],
  "INV-069": [ // Blood Collection Tubes (SST — Gold)
    { location: "Lab Supply Room — CCRMC", floor: "CCRMC 1st Floor", qty: 4500, storageType: "shelf" },
    { location: "Lab — Blood Bank", floor: "CCRMC 1st Floor", qty: 2500, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 1800, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 1000, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 700, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 500, storageType: "shelf" },
  ],
  "INV-071": [ // Rapid Strep Test Kit
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 800, storageType: "shelf" },
    { location: "Lab — Testing Area", floor: "CCRMC 1st Floor", qty: 600, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 500, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 300, storageType: "shelf" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 200, storageType: "shelf" },
  ],
  "INV-072": [ // Troponin I Test Cartridge
    { location: "Lab Supply Room — CCRMC", floor: "CCRMC 1st Floor", qty: 600, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 500, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 300, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 400, storageType: "shelf" },
  ],
  "INV-073": [ // Blood Gas Syringe Kit
    { location: "Lab Supply Room — CCRMC", floor: "CCRMC 1st Floor", qty: 800, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 400, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 400, storageType: "shelf" },
    { location: "Respiratory Therapy — CCRMC", floor: "CCRMC 3rd Floor", qty: 300, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 300, storageType: "shelf" },
  ],
  "INV-077": [ // Tegaderm Transparent Dressing (10x12cm)
    ...
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 600, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 500, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4B", floor: "CCRMC 4th Floor", qty: 600, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4A", floor: "CCRMC 4th Floor", qty: 500, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 400, storageType: "shelf" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 400, storageType: "shelf" },
  ],
  "INV-078": [ // Sterile Gauze Pads 4x4 (12-ply)
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 6000, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 2000, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 1500, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4B", floor: "CCRMC 4th Floor", qty: 1500, storageType: "shelf" },
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 2000, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 1000, storageType: "shelf" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 1000, storageType: "shelf" },
  ],
  "INV-079": [ // Alcohol Prep Pads
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 10000, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 4000, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 3000, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4B", floor: "CCRMC 4th Floor", qty: 3000, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4A", floor: "CCRMC 4th Floor", qty: 2000, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 3000, storageType: "shelf" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 3000, storageType: "shelf" },
  ],
  "INV-080": [ // Pressure Injury Prevention Mattress Overlay (LOW STOCK)
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 12, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4B", floor: "CCRMC 4th Floor", qty: 6, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4A", floor: "CCRMC 4th Floor", qty: 5, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 4, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 3, storageType: "shelf" },
  ],
  "INV-082": [ // Chest Tube Drainage Kit (28Fr)
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 15, storageType: "cabinet" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 12, storageType: "cabinet" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 10, storageType: "shelf" },
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 8, storageType: "cabinet" },
  ],
  "INV-083": [ // Fetal Scalp Electrode
    { location: "CCRMC Family Birth Center Supply", floor: "CCRMC 2nd Floor", qty: 90, storageType: "shelf" },
    { location: "CCRMC Family Birth Center Medication Room", floor: "CCRMC 2nd Floor", qty: 30, storageType: "cabinet" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 20, storageType: "shelf" },
  ],
  "INV-084": [ // Amniotomy Hook (Disposable)
    { location: "CCRMC Family Birth Center Supply", floor: "CCRMC 2nd Floor", qty: 130, storageType: "shelf" },
    { location: "CCRMC Family Birth Center Medication Room", floor: "CCRMC 2nd Floor", qty: 40, storageType: "cabinet" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 30, storageType: "shelf" },
  ],
  "INV-085": [ // C-Section Drape Kit
    { location: "CCRMC Family Birth Center Supply", floor: "CCRMC 2nd Floor", qty: 50, storageType: "shelf" },
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 25, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 15, storageType: "shelf" },
  ],
  "INV-086": [ // Infant Warmer Liner
    { location: "CCRMC Family Birth Center Supply", floor: "CCRMC 2nd Floor", qty: 220, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 80, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 50, storageType: "shelf" },
  ],
  "INV-087": [ // Magnesium Sulfate 4g/100mL IV (LOW STOCK)
    { location: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", qty: 30, storageType: "shelf" },
    { location: "CCRMC Family Birth Center Pyxis", floor: "CCRMC 2nd Floor", qty: 25, storageType: "pyxis" },
    { location: "CCRMC Family Birth Center Medication Room", floor: "CCRMC 2nd Floor", qty: 15, storageType: "shelf" },
    { location: "ICU Pyxis Station", floor: "CCRMC 3rd Floor", qty: 10, storageType: "pyxis" },
  ],
  "INV-089": [ // Intracranial Pressure Monitor Kit (LOW STOCK)
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 8, storageType: "cabinet" },
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 4, storageType: "cabinet" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 3, storageType: "shelf" },
  ],
  ...
  "INV-091": [ // Drug-Eluting Stent (3.0x18mm)
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 18, storageType: "cabinet" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 10, storageType: "shelf" },
  ],
  "INV-092": [ // ECG Electrode Pads (50-pack)
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 800, storageType: "shelf" },
    { location: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", qty: 400, storageType: "shelf" },
    { location: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", qty: 300, storageType: "shelf" },
    { location: "CCRMC Med/Surg 4B", floor: "CCRMC 4th Floor", qty: 300, storageType: "shelf" },
    { location: "Martinez Health Center Supply Room", floor: "Martinez Health Center", qty: 300, storageType: "shelf" },
    { location: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", qty: 300, storageType: "shelf" },
  ],
  "INV-093": [ // Surgical Stapler (Endo GIA 60mm)
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 35, storageType: "cabinet" },
    { location: "SPD — Sterile Processing", floor: "Basement", qty: 15, storageType: "shelf" },
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 10, storageType: "shelf" },
  ],
  "INV-094": [ // Surgical Stapler Reload (Endo GIA 60mm)
    { location: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", qty: 80, storageType: "shelf" },
  ...
  "INV-095": [ // Cell Saver Tubing Set (LOW STOCK)
    ...
    { location: "CCRMC Central Warehouse", floor: "Basement", qty: 4, storageType: "shelf" },
  ],
};
...
export const delayedShipments: DelayedShipment[] = [
  ...
  },
  {
    ...
    mitigationOptions: [
      ...
      "Transfer 100 bags Normal Saline from Martinez Health Center (they have 30-day surplus)",
    ],
  },
  {
    id: "DEL-8899",
...
export const recentActivity = [
  { time: "08:45 AM", action: "Stock received", detail: "900 units of IV Catheter 20G — received at CCRMC Central Warehouse, distributed to ED Supply Room & CCRMC ICU", user: "M. Rodriguez" },
...
export const parLocations: ParLocation[] = [
  // === Contra Costa Regional Medical Center (CCRMC) — hospital PAR locations ===
  { id: "PAR-001", name: "CCRMC Central Warehouse", floor: "Basement", department: "Materials Management", locationType: "warehouse", managedBy: "Materials Management", restockCycle: "weekly", lastRestocked: "2026-03-15T06:00:00", itemCount: 5694, fillRate: 94, status: "normal", supplyChain: "mixed" },
  { id: "PAR-002", name: "CCRMC ED Supply Room", floor: "CCRMC 1st Floor", department: "Emergency Department", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-16T06:15:00", itemCount: 624, fillRate: 87, status: "normal", supplyChain: "med-surg" },
  { id: "PAR-003", name: "ED Pyxis MedStation #1", floor: "CCRMC 1st Floor", department: "Emergency Department", locationType: "adc", adcModel: "Pyxis MedStation ES", managedBy: "Pharmacy", restockCycle: "twice-daily", lastRestocked: "2026-03-16T05:30:00", itemCount: 284, fillRate: 78, status: "normal", supplyChain: "pharmacy" },
  { id: "PAR-004", name: "ED Trauma Bay Supply", floor: "CCRMC 1st Floor", department: "Emergency Department", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "shift-change", lastRestocked: "2026-03-16T07:00:00", itemCount: 170, fillRate: 91, status: "normal", supplyChain: "med-surg" },
  { id: "PAR-005", name: "CCRMC ICU Supply Room", floor: "CCRMC 3rd Floor", department: "Intensive Care Unit", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-15T14:30:00", itemCount: 490, fillRate: 72, status: "low", supplyChain: "med-surg" },
  { id: "PAR-006", name: "ICU Pyxis MedStation #3", floor: "CCRMC 3rd Floor", department: "Intensive Care Unit", locationType: "adc", adcModel: "Pyxis MedStation ES", managedBy: "Pharmacy", restockCycle: "twice-daily", lastRestocked: "2026-03-16T05:45:00", itemCount: 336, fillRate: 81, status: "normal", supplyChain: "pharmacy" },
  { id: "PAR-007", name: "CCRMC OR Supply Core", floor: "CCRMC 2nd Floor", department: "Operating Rooms", locationType: "sterile-core", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-15T16:00:00", itemCount: 1782, fillRate: 79, status: "low", supplyChain: "surgical" },
  { id: "PAR-008", name: "OR Anesthesia Cart — Room 4", floor: "CCRMC 2nd Floor", department: "Operating Rooms", locationType: "cart", managedBy: "Pharmacy", restockCycle: "shift-change", lastRestocked: "2026-03-15T19:00:00", itemCount: 96, fillRate: 65, status: "critical", supplyChain: "pharmacy" },
  { id: "PAR-009", name: "CCRMC Med/Surg 4A Supply", floor: "CCRMC 4th Floor", department: "Med/Surg", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-16T06:30:00", itemCount: 396, fillRate: 106, status: "overstocked", supplyChain: "med-surg" },
  { id: "PAR-010", name: "CCRMC Med/Surg 4B Supply", floor: "CCRMC 4th Floor", department: "Med/Surg", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-16T06:45:00", itemCount: 408, fillRate: 82, status: "normal", supplyChain: "med-surg" },
  { id: "PAR-011", name: "CCRMC Med/Surg 4B Omnicell", floor: "CCRMC 4th Floor", department: "Med/Surg", locationType: "adc", adcModel: "Omnicell XT", managedBy: "Pharmacy", restockCycle: "twice-daily", lastRestocked: "2026-03-16T05:50:00", itemCount: 268, fillRate: 88, status: "normal", supplyChain: "pharmacy" },
  { id: "PAR-012", name: "Pharmacy — CCRMC Main", floor: "CCRMC 1st Floor", department: "Pharmacy", locationType: "satellite-pharmacy", managedBy: "Pharmacy", restockCycle: "as-needed", lastRestocked: "2026-03-15T22:00:00", itemCount: 2490, fillRate: 91, status: "normal", supplyChain: "pharmacy" },
  { id: "PAR-013", name: "Pharmacy — Controlled Substance Vault", floor: "CCRMC 1st Floor", department: "Pharmacy", locationType: "satellite-pharmacy", managedBy: "Pharmacy", restockCycle: "as-needed", lastRestocked: "2026-03-15T20:00:00", itemCount: 174, fillRate: 95, status: "normal", supplyChain: "pharmacy" },
  { id: "PAR-014", name: "Satellite Pharmacy — CCRMC ICU", floor: "CCRMC 3rd Floor", department: "Pharmacy", locationType: "satellite-pharmacy", managedBy: "Pharmacy", restockCycle: "daily", lastRestocked: "2026-03-16T06:00:00", itemCount: 468, fillRate: 83, status: "normal", supplyChain: "pharmacy" },
  { id: "PAR-015", name: "Lab Supply Room — CCRMC", floor: "CCRMC 1st Floor", department: "Laboratory", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "weekly", lastRestocked: "2026-03-15T10:00:00", itemCount: 734, fillRate: 96, status: "normal", supplyChain: "lab" },
  { id: "PAR-016", name: "Lab — Blood Bank", floor: "CCRMC 1st Floor", department: "Laboratory", locationType: "supply-room", managedBy: "Laboratory", restockCycle: "weekly", lastRestocked: "2026-03-15T10:30:00", itemCount: 290, fillRate: 92, status: "normal", supplyChain: "lab" },
  ...
  { id: "PAR-018", name: "Isolation Cart — 4A", floor: "CCRMC 4th Floor", department: "Med/Surg", locationType: "cart", managedBy: "Materials Management", restockCycle: "shift-change", lastRestocked: "2026-03-15T19:00:00", itemCount: 68, fillRate: 45, status: "critical", supplyChain: "med-surg" },
  { id: "PAR-019", name: "Transplant Supply Room", floor: "CCRMC 4th Floor", department: "Transplant Services", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-16T06:10:00", itemCount: 312, fillRate: 89, status: "normal", supplyChain: "med-surg" },
  { id: "PAR-020", name: "Neuro ICU Supply Room", floor: "CCRMC 3rd Floor", department: "Neurosciences", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-16T06:05:00", itemCount: 278, fillRate: 84, status: "normal", supplyChain: "med-surg" },

  // === CCRMC — Family Birth Center, NICU, Oncology & Pediatrics ===
  { id: "PAR-021", name: "CCRMC Family Birth Center Supply Room", floor: "CCRMC 2nd Floor", department: "Labor & Delivery", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-16T06:20:00", itemCount: 312, fillRate: 93, status: "normal", supplyChain: "med-surg" },
  { id: "PAR-022", name: "CCRMC Family Birth Center Pyxis", floor: "CCRMC 2nd Floor", department: "Labor & Delivery", locationType: "adc", adcModel: "Pyxis MedStation ES", managedBy: "Pharmacy", restockCycle: "twice-daily", lastRestocked: "2026-03-16T05:40:00", itemCount: 196, fillRate: 85, status: "normal", supplyChain: "pharmacy" },
  { id: "PAR-023", name: "CCRMC NICU Supply", floor: "CCRMC 3rd Floor", department: "Intensive Care Unit", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-16T06:25:00", itemCount: 345, fillRate: 91, status: "normal", supplyChain: "med-surg" },
  { id: "PAR-024", name: "Martinez Health Center Central Supply", floor: "Martinez Health Center", department: "Materials Management", locationType: "warehouse", managedBy: "Materials Management", restockCycle: "weekly", lastRestocked: "2026-03-15T07:00:00", itemCount: 1842, fillRate: 90, status: "normal", supplyChain: "mixed" },
  { id: "PAR-025", name: "Martinez Health Center Pharmacy", floor: "Martinez Health Center", department: "Pharmacy", locationType: "satellite-pharmacy", managedBy: "Pharmacy", restockCycle: "daily", lastRestocked: "2026-03-16T06:00:00", itemCount: 856, fillRate: 87, status: "normal", supplyChain: "pharmacy" },
  { id: "PAR-026", name: "CCRMC Oncology Supply", floor: "CCRMC 4th Floor", department: "Oncology / Cancer Center", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-16T06:30:00", itemCount: 267, fillRate: 92, status: "normal", supplyChain: "med-surg" },

  // === Martinez Health Center & Martinez Wellness Center (outpatient clinics) ===
  { id: "PAR-027", name: "Martinez Wellness Center Supply Room", floor: "Martinez Wellness Center", department: "Materials Management", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-16T06:15:00", itemCount: 423, fillRate: 88, status: "normal", supplyChain: "med-surg" },
  { id: "PAR-028", name: "CCRMC Ambulatory Surgery Supply", floor: "CCRMC 2nd Floor", department: "Operating Rooms", locationType: "sterile-core", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-16T05:45:00", itemCount: 612, fillRate: 82, status: "normal", supplyChain: "surgical" },
  { id: "PAR-029", name: "Martinez Wellness Center Pharmacy", floor: "Martinez Wellness Center", department: "Pharmacy", locationType: "satellite-pharmacy", managedBy: "Pharmacy", restockCycle: "daily", lastRestocked: "2026-03-16T06:00:00", itemCount: 534, fillRate: 90, status: "normal", supplyChain: "pharmacy" },

  // === Contra Costa clinics — shared central supply ===
  { id: "PAR-030", name: "Martinez Wellness Center Central Supply", floor: "Martinez Health Center", department: "Materials Management", locationType: "warehouse", managedBy: "Materials Management", restockCycle: "weekly", lastRestocked: "2026-03-15T06:30:00", itemCount: 1456, fillRate: 91, status: "normal", supplyChain: "mixed" },
  { id: "PAR-031", name: "CCRMC Pediatrics Supply", floor: "CCRMC 3rd Floor", department: "Intensive Care Unit", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-16T06:10:00", itemCount: 287, fillRate: 86, status: "normal", supplyChain: "med-surg" },
  { id: "PAR-032", name: "CCRMC Pediatric ED Supply", floor: "Martinez Health Center", department: "Emergency Department", locationType: "supply-room", managedBy: "Materials Management", restockCycle: "daily", lastRestocked: "2026-03-16T06:20:00", itemCount: 345, fillRate: 83, status: "normal", supplyChain: "med-surg" },
];
...
export const locationImbalances: LocationImbalance[] = [
  {
    ...
    locations: [
      { locationName: "CCRMC Med/Surg 4A Supply", currentQty: 3600, parLevel: 2000, pctOfPar: 180, status: "overstocked" },
      { locationName: "CCRMC ICU Supply Room", currentQty: 672, parLevel: 1600, pctOfPar: 42, status: "critical" },
      { locationName: "CCRMC ED Supply Room", currentQty: 2400, parLevel: 2400, pctOfPar: 100, status: "at-par" },
      { locationName: "CCRMC Central Warehouse", currentQty: 12000, parLevel: 14000, pctOfPar: 86, status: "below-par" },
    ],
    suggestedTransfer: { from: "CCRMC Med/Surg 4A Supply", to: "CCRMC ICU Supply Room", qty: 800, reason: "ICU at 42% of PAR while Med/Surg 4A is overstocked at 180% — likely hoarding after flu surge alert" },
  },
  {
    itemId: "INV-006",
    itemName: "Heparin Sodium 5000U/mL",
    locations: [
      { locationName: "Pharmacy — CCRMC Main", currentQty: 50, parLevel: 120, pctOfPar: 42, status: "below-par" },
      { locationName: "ICU Pyxis MedStation #3", currentQty: 16, parLevel: 40, pctOfPar: 40, status: "critical" },
      { locationName: "CCRMC Med/Surg 4B Omnicell", currentQty: 10, parLevel: 30, pctOfPar: 33, status: "critical" },
      { locationName: "ED Pyxis MedStation #1", currentQty: 14, parLevel: 30, pctOfPar: 47, status: "below-par" },
    ],
    suggestedTransfer: { from: "Pharmacy — CCRMC Main", to: "ICU Pyxis MedStation #3", qty: 24, reason: "ICU Pyxis below ADC par of 40 — redistribute from Pharmacy pending PO-4521 arrival (ETA Mar 20)" },
  },
  {
    itemId: "INV-002",
    itemName: "N95 Respirator Masks",
    locations: [
      { locationName: "CCRMC ED Supply Room", currentQty: 1000, parLevel: 1000, pctOfPar: 100, status: "at-par" },
      { locationName: "Isolation Cart — 4A", currentQty: 36, parLevel: 80, pctOfPar: 45, status: "critical" },
      { locationName: "CCRMC Central Warehouse", currentQty: 3000, parLevel: 4000, pctOfPar: 75, status: "below-par" },
      { locationName: "CCRMC ICU Supply Room", currentQty: 600, parLevel: 700, pctOfPar: 86, status: "below-par" },
    ],
    suggestedTransfer: { from: "CCRMC ED Supply Room", to: "Isolation Cart — 4A", qty: 40, reason: "Isolation Cart at 45% of PAR — compliance finding FND-005 requires 48-hour coverage. Transfer 40 from ED (at full PAR) to close gap" },
  },
  {
    itemId: "INV-004",
    ...
    locations: [
      ...
      { locationName: "Pharmacy — CCRMC Main", currentQty: 240, parLevel: 240, pctOfPar: 100, status: "at-par" },
