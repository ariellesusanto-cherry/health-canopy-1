  ...
  "supply-chain-manager": [
    {
      ...
      body: "One place for the work that today lives in separate systems and spreadsheets — supplies, vaccines, fridges, and compliance. This 60-second tour hits the highlights. You can restart it anytime from your profile menu.",
    },
    {
      route: "/",
      target: "kpis",
      title: "The whole system at a glance",
      body: "18,470 items tracked across CCRMC and the Martinez clinics, with 7 more county health centers coming next. These numbers are live — they always match what you'll see on the detail pages.",
    },
    {
      route: "/",
      target: "attention",
      title: "What needs you right now",
      body: "Not just supply shortages. The VFC badges are vaccine lots that expire soon — each with the recommended fix: use them first, or transfer them to a clinic that needs them so nothing goes to waste.",
    },
    {
      route: "/",
      target: "cold-chain-live",
      title: "Fridges, watched around the clock",
      body: "\u201cCold chain\u201d just means keeping vaccines properly cold every minute from the factory to the patient — one warm weekend ruins them. Here, every fridge reports its temperature automatically. Keep an eye on the Martinez Wellness fridge — it's running warm.",
    },
    {
      route: "/cold-chain",
      target: "cold-chain-detail",
      title: "No more paper temperature logs",
      body: "Each fridge logs a reading every 10 minutes. The chart shows the safe zone (36–46°F), the alarm lines, and when each sensor's calibration is due — so you're always ready for a state inspection.",
    },
    {
      route: "/vaccine-management",
      target: "scan-inspector",
      title: "One scan does the paperwork",
      body: "When a nurse gives a vaccine, she scans the vial once. That single scan updates the patient's chart, reports the dose to the state registry, updates the fridge count, and logs it for the federal vaccine program. No double entry — expand a scan to see it.",
    },
    {
      route: "/forecasting",
      target: "scenarios",
      title: "See problems before they happen",
      body: "What-if scenarios show how a flu surge or a supplier delay would hit your stock — and exactly what to order now, down to quantities and suppliers.",
    },
    {
      route: "/forecasting",
      target: "ai-assistant",
      title: "Ask anything in plain English",
      body: "The assistant reads the same live data you see on screen — stock, fridges, orders, compliance. Try \u201cWhich fridge should I be worried about?\u201d",
    },
    {
      route: "/forecasting",
      target: "demo-director",
      title: "For presenters",
      body: "This button runs a live drill: a fridge overheats, the platform catches it, and you resolve it — end to end. Toggle the panel with Shift+D. Enjoy the demo!",
    },
  ],
  "nurse-unit-coordinator": [
    {
      route: "/unit",
      title: "Your unit, your view",
      body: "Everything here is scoped to your unit: your stock, your alerts, your deliveries, your vaccine fridges. None of the system-wide noise, none of the finance dashboards.",
    },
    {
      route: "/unit",
      target: "unit-summary",
      title: "Your stock at a glance",
      body: "How many items you track, what's running low, what's critical, and what's out. Cover more than one unit? Switch with the selector above.",
    },
    {
      route: "/unit",
      target: "unit-fridges",
      title: "Vaccine fridges, live",
      body: "Live temperatures from every vaccine fridge, updated continuously — no clipboard checks. Amber means a fridge is getting close to its limit; tap through for the full charts.",
    },
    {
      route: "/inventory",
      target: "inv-summary",
      title: "Inventory, scoped to you",
      body: "The inventory page shows only your unit's items. Request restocks and flag stockouts right from the list. That's the tour — you're set!",
    },
  ],
  executive: [
    {
      ...
      body: "One read-only page for leadership: the key numbers, compliance readiness, critical alerts, and where the rollout stands across the county. No actions to take — just the state of the system.",
    },
    {
      route: "/executive",
      target: "exec-readiness",
      title: "Compliance, tracked all year",
      body: "Joint Commission readiness is monitored continuously — not assembled in a scramble before a survey.",
    },
    {
      route: "/executive",
      target: "exec-sites",
      title: "The rollout path",
      body: "Three sites live today. Seven county health centers next: Antioch, Pittsburg, Concord, San Pablo, Brentwood, North Richmond, and Bay Point.",
    },
    {
      route: "/budget",
      target: "fin-kpis",
      title: "Financials — see everything, touch nothing",
      body: "Full visibility into budget, spending, and orders. Approvals stay with the supply chain team — by design. That's the tour.",
    },
  ],
};
